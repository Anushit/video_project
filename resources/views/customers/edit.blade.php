          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                {{ Form::open(array('route' => array('customers.update',$id), 'files' => true, 'method' => 'post','id'=>'usersForm')) }}
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                      ...
                      {{ Form::text('dob', $data->userDetails->dob, array('class'=>'form-control date-of-birth' , 'placeholder' => 'Date of Birth','maxlength'=>100,'id'=>'dob')) }}
                      <span class="text-danger">{{ $errors->first('dob') }}</span>
                    </div>
                  </div>
                  <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                      <label for="phone">DOJ</label>
                      {{ Form::text('doj', $data->userDetails->doj, array('class'=>'form-control date-of-join' , 'placeholder' => 'Date of Joining','maxlength'=>100,'id'=>'doj')) }}
