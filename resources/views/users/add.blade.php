          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                {{ Form::open(array('route' => 'users.store', 'files' => true, 'method' => 'post','id'=>'usersForm')) }}
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                      ...
                      {{ Form::select('role_id',[null=>"Select Role"]+$roles,old('role_id'),array('class'=>'form-control','id'=>'role_id')) }}
